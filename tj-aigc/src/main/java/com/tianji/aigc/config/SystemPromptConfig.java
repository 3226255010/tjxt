...
public class SystemPromptConfig {
    ...
    private final AtomicReference<String> courseAgentSystemMessage = new AtomicReference<>();
    ...
    public void init() {
        ...
        loadConfig(aiProperties.getSystem().getCourseAgent(), courseAgentSystemMessage);
